...
## Report bugs using GitHub's [issues](https://github.com/SkinDB/SkinDB.net/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/SkinDB/SkinDB.net/issues/new) – it's that easy!
